...
import AWEwpaperRF from '../../../pdf/ferman_lima_riva__AWE_wpaper_0221_fig1.png';
import './styles.css';
...
const WorkingPapers = () => {
  ...
  return (
    <div id="working-papers">
      ...
      <p>
        <span className="link" onClick={() => setAbstractIsVisible(!abstractIsVisible)}>Abstract{abstractIsVisible ? ': ' : " (click to expand)"}</span>
      ...
      <p><a href='https://twitter.com/friva_/status/1361716148153245698'>Twitter Thread</a></p>
      <p>
        <span>Media: </span>
